    ...
    return (
        <div className="container mt-5">
            <div className="row text-center">
                ...
                <button className="mt-5 p-2 fs-5 btn btn-primary mb-5" style={{width: "20%", margin: "0 auto"}}><Link className="nav-link active" to="/signup" style={{marginLeft: 0}}>Signup now</Link></button>
            </div>
        </div>
    );
}
