    ...
    return (
        <div className="container">
            <div className="row p-5 mb-5 mt-5">
                ...
                <div className="col-4 p-5 mt-2">
                    <h4 className=""><i class="fa-solid fa-chart-column"></i>Your Zerodha Account</h4>
                    ...
                    <br />
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Kite API</a>
                    <br />
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Pi and other platforms</a>
                    <br />
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Stockreports+</a>
                    <br />
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>GTT</a>
                    <br />
                </div>
                <div className="col-4 p-5 mt-2">
                    <h4 className=""><i class="fa-solid fa-radio"></i>Funds</h4>
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Adding Funds</a>
                    <br />
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Fund Withdrawal</a>
                    <br />
                ...
                <div className="col-4 p-5 mt-2">
                    <h4 className=""><i class="fa-solid fa-rotate-right"></i>Console</h4>
                ...
                <div className="col-4 p-5 mt-2">
                    <h4 className=""><i class="fa-regular fa-circle"></i>Coin</h4>
                    ...
                    <br />
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Buying and Selling through Coin</a>
                    <br />
                    ...
                    <br />
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Moving to Coin</a>
                    <br />
